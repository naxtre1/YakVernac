...
const itemSkus = Platform.select({
  ...
  // ],
  android: [
    'bronze_package_03072017',
    'silver_package_03072017',
    'gold_package_03072017'
      ...
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          //  onPress={() => this.getItems()}
           activeOpacity={0.5}
           style={styles.btn}>
          <Text style={styles.txt}>Get Products ({productList.length})</Text>
        </TouchableOpacity>
          ...
          onPress={() =>
           ...
           activeOpacity={0.5}
           style={styles.btn}>
          <Text style={styles.txt}> Request purchase for above product</Text>
        </TouchableOpacity>
