                        ...
                        <View style={{ margin: 20, justifyContent: 'space-between', flex: 1 }}>
                            <View style={{ marginTop: 10, flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                <Icon
                                    ...
                                    color={'grey'}
                                />
                                <Text style={{ marginLeft: 10, marginRight:10 }}>{strings('Create.presstorecord')}</Text>
                            </View>
                            <View style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                <Icon
                                    name='play'
                                    ...
                                    color={'grey'}
                                />
                                <Text style={{ marginLeft: 10, marginRight:10 }}>{strings('Create.listentorecord')}</Text>
                            </View>
                            <TextInput
                                editable={false}
                                placeholder={strings('Create.writeyouranswerhere')}
                    ...
                    <View style={{ margin: 20, flex: 1, justifyContent: 'space-around' }}>
                        ...
                        >
                            <Icon
                                ...
                                color={playing ? 'red' : 'grey'}
                            />
                            <Text style={{ marginLeft: 10, marginRight:10 }}>{playing ? 'Playing...' : strings('Create.listentorecord')}</Text>
                        </TouchableOpacity>
                        <TextInput
                            placeholder={strings('Create.writeyouranswerhere')}
                            placeholderTextColor={colors.blue}
    ...
    const onCreatePostData = () => {
        ...
        storageUpload('media', uploadImage).then(url => {
            firestore().collection('user').doc(user.uid).collection('games').add({
                ...
                let dateTime = formatTime(currentDate.getHours()) + ":" + formatTime(currentDate.getMinutes()) + " " + formatTime(currentDate.getDate()) + "/" + formatTime(currentDate.getMonth() + 1) + "/" + formatTime(currentDate.getFullYear().toString().substr(-2));
                                ...
                                <View style={{ flex: 1 }}>
                                    ...
                                    <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                                        <TouchableOpacity
                                            ...
                                            <Text style={styles.blackueBtnTitle}>Send to friend</Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity
                                            style={styles.blackButton}
                                            onPress={() => {
